  ...
  componentDidMount() {
    if (localStorage.length === 0) {
      ...
      localStorage.setItem(
        "searchTable",
        JSON.stringify(this.state.searchTable)
      );
      localStorage.setItem(
        "incomingTable",
        JSON.stringify(this.state.incomingTable)
      );
      localStorage.setItem(
        "supplierTable",
        JSON.stringify(this.state.supplierTable)
      );
      localStorage.setItem(
        "supplierCatalogTable",
        JSON.stringify(this.state.supplierCatalogTable)
      );
