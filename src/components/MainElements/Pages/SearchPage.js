...
class SearchPage extends React.Component {
  ...
  componentDidMount() {
    this.setState({
      table: localStorage.getItem("searchTable")
        ? JSON.parse(localStorage.getItem("searchTable"))
        : this.state.table,
    });
  }
  ...
  render() {
    ...
    return (
      <main className="main main-rush">
        ...
        <SearchTable data={tableData} handleRowClick={this.handleRowClick} />
        <SearchModal
        ...
        />
        <div className="supplier-footer"></div>
      </main>
    );
  }
}
