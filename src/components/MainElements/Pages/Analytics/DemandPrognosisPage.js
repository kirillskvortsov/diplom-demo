  ...
  render() {
    return (
      <main className="main main-analytics">
        ...
        <h4 className="demand-table-header">
          Частота пополнения склада: 30 дней
        </h4>
        <h4 className="demand-table-header">
          Свободного места на складе: {this.state.area} м<sup>2</sup> (
          {((this.state.area / 1500) * 100).toFixed(2)}%)
        </h4>
        <h4 className="sub-header">Список запчастей</h4>
        <DemandPrognosisTable data={this.state.table} />
